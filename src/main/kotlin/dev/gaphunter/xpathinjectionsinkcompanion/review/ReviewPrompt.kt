package dev.gaphunter.xpathinjectionsinkcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.xpathinjectionsinkcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.xpathinjectionsinkcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "XPath Injection Sink Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34069-xpath-injection-sink-companion/reviews"
